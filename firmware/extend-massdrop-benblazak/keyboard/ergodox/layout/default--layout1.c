...
KB_MATRIX_LAYER(
	...
	KEY_RightAlt,	KEY_a_A,	KEY_s_S,	KEY_t_T,	KEY_f_F,	KEY_g_G,	
	KEY_LeftShift,	KEY_z_Z,	KEY_x_X,	KEY_c_C,	KEY_v_V,	KEY_b_B,	KEY_F2,	
	KEY_LeftControl,	KEY_LeftGUI,	KEY_LeftAlt,	KEY_Semicolon_Colon,	KEY_SingleQuote_DoubleQuote,	
	KEY_Home,	KEY_End,	
	0,	0,	KEY_PageUp,	
	KEY_Spacebar,	KEY_DeleteBackspace,	KEY_PageDown,	
	// right hand
	...
	KEY_F3,	KEY_y_Y,	KEY_u_U,	KEY_i_I,	KEY_l_L,	KEY_p_P,	KEY_DeleteForward,	
	KEY_h_H,	KEY_n_N,	KEY_e_E,	KEY_o_O,	KEY_RightBracket_RightBrace,	KEY_RightAlt,	
	KEY_F4,	KEY_j_J,	KEY_m_M,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_Slash_Question,	KEY_RightShift,	
	KEY_LeftBracket_LeftBrace,	KEY_Dash_Underscore,	KEY_LeftAlt,	KEY_RightGUI,	KEY_RightControl,	
...
KB_MATRIX_LAYER(
	...
	0,	0,	0,	0,	0,	0,	KEY_F10,	
	0,	0,	0,	0,	0,	
	KEY_PrintScreen,	KEY_Mute,	
	0,	0,	KEY_VolumeUp,	
	0,	0,	KEY_VolumeDown,	
	// right hand
	0,	0,	0,	KEYPAD_Slash,	KEYPAD_Asterisk,	KEYPAD_Minus,	KEY_Pause,	
	KEY_F11,	0,	KEYPAD_7_Home,	KEYPAD_8_UpArrow,	KEYPAD_9_PageUp,	KEYPAD_Plus,	0,	
	0,	KEYPAD_4_LeftArrow,	KEYPAD_5,	KEYPAD_6_RightArrow,	KEYPAD_Plus,	0,	
	KEY_F12,	0,	KEYPAD_1_End,	KEYPAD_2_DownArrow,	KEYPAD_3_PageDown,	KEY_ReturnEnter,	0,	
